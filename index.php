...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="container px-5">
            <a class="navbar-brand" href="#page-top"><img src="./img/1- 1.png" width="60px">𝔸ℙ𝕃𝕌𝕊 𝔻𝕒𝕟𝕔𝕖 𝕊𝕥𝕦𝕕𝕚𝕠
            </a>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="./img/螢幕擷取畫面 2026-01-06 031042.png" alt="..." /></div>
                </div>
    ...
    <section>
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="./img/螢幕擷取畫面 2026-01-06 031243.png" alt="..." /></div>
                </div>
                <div class="col-lg-6">
                    <div class="p-1">
    ...
    <section>
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="./img/螢幕擷取畫面 2026-01-06 031544.png" alt="..." /></div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
